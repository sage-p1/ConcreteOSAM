...
degrees=(20 100)
powers=$(seq 5 20)
algorithms=("bfs" "dfs" "dijkstra" "prim")
              ...
              for pointer in "${pointers[@]}"; do
                ...
                for move_semantics in "${move_semantics_plural[@]}"; do
                  ...
                  for algorithm in "${algorithms[@]}"; do
                    ...
                    echo "Launching test: --n $n --d $d --bs $bs --trials $trials --pt $pointer --alg $algorithm $move_line $copies_line $prime_line $static_line --wl $walk_length --df $damping_factor"
