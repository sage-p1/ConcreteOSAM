...
class Vertex():
    ...
    def __setstate__(self, state):
        ...
        header_size = struct.calcsize('<iiii?I')
        (self.id, self.out_degree, self.height, lbl, self.visited, num_children) = struct.unpack('<iiii?I', state[:header_size])
...
class OutEdge():
    ...
    def __setstate__(self, state):
        ...
        header_size = struct.calcsize('<iiii?I')
        (self.weight, d_id, ogE_addr, lbl, self.is_leaf, num_children) = struct.unpack('<iiii?I', state[:header_size])
